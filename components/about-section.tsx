    ...
    <section id="nosotros" className="py-24 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">{companyInfo.about.history}</p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
          <div className="space-y-8">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">{companyInfo.about.history}</p>
            </div>

            <div>
              <h3 className="text-2xl font-bold mb-4">Nuestra Visión</h3>
              <p className="text-muted-foreground leading-relaxed">{companyInfo.about.vision}</p>
            </div>
