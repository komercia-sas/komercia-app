...
// Función para obtener las clases de variantes sin class-variance-authority
function getButtonVariants(variant: string = 'default', size: string = 'default', className?: string) {
