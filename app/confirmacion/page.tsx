            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="text-center p-4 bg-muted/30 rounded-lg">
                  ...
                  <div className="text-xs text-muted-foreground">{companyInfo.contact.phone}</div>
                </div>
                <div className="text-center p-4 bg-muted/30 rounded-lg">
                  <Mail className="h-6 w-6 text-primary mx-auto mb-2" />
                  <div className="text-sm font-medium">Email</div>
                  <div className="text-xs text-muted-foreground">{companyInfo.contact.email}</div>
                </div>
                <div className="text-center p-4 bg-muted/30 rounded-lg">
                  <Home className="h-6 w-6 text-primary mx-auto mb-2" />
                  <div className="text-sm font-medium">Tienda</div>
                  <div className="text-xs text-muted-foreground">Lun-Vie 8AM-6PM</div>
                </div>
              </div>
            </CardContent>
          </Card>
