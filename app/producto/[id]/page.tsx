...
import { ShoppingCart, ArrowLeft, Check, Truck, Shield, HeadphonesIcon } from "lucide-react"
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-lg text-muted-foreground text-pretty">{product.shortDescription}</p>
            </div>
            ...
            {product.inStock ? (
              ...
              <div className="text-destructive font-medium">Producto agotado</div>
            )}
            ...
            {product.inStock && (
              <div className="space-y-4">
                ...
                <Button onClick={handleAddToCart} size="lg" className="w-full btn-primary">
